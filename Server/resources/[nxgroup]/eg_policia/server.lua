...
function eG.getGun(data)
    ...
    if authPolice == true then
        if vRP.hasPermission(user_id,cFG.permPolicia2) then
            ...
            if liberado == 1 then
                if vRP.tryFullPayment(user_id,data.preco) then
                    if data.spawn == 'item' then
                        ...
                        TriggerClientEvent("Notify",source,"sucesso","Você comprou um(a) <b>"..data.arma.."</b> por R$<b>"..data.preco.."</b>.")
                        ...
                        TriggerClientEvent("Notify",source,"sucesso","Você pegou uma <b>"..data.arma.."</b> por R$<b>"..data.preco.."</b>.")
