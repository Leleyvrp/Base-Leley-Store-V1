...
function src.checkRoupas()
	...
	local user_id = vRP.getUserId(source)
	if user_id then
		if vRP.getInventoryItemAmount(user_id,"roupas") >= 1 or vRP.hasPermission(user_id,"diamante.permissao") or vRP.hasPermission(user_id,"esmeralda.permissao") or vRP.hasPermission(user_id,"flush.permissao") then
			return true 
		else
...
local salarios = {
	...
	{ ['permissao'] = "bronze2.permissao", ['nome'] = "Bronze2", ['payment'] = 2000 },
	{ ['permissao'] = "bronze3.permissao", ['nome'] = "Bronze3", ['payment'] = 2000 },
	{ ['permissao'] = "bronze4.permissao", ['nome'] = "Bronze4", ['payment'] = 2000 },
	{ ['permissao'] = "prata.permissao", ['nome'] = "Prata", ['payment'] = 4000 },
	{ ['permissao'] = "prata2.permissao", ['nome'] = "Prata2", ['payment'] = 4000 },
	{ ['permissao'] = "prata3.permissao", ['nome'] = "Prata3", ['payment'] = 4000 },
	{ ['permissao'] = "prata4.permissao", ['nome'] = "Prata4", ['payment'] = 4000 },
	{ ['permissao'] = "ouro.permissao", ['nome'] = "Ouro", ['payment'] = 6000 },
	{ ['permissao'] = "ouro2.permissao", ['nome'] = "Ouro2", ['payment'] = 6000 },
	{ ['permissao'] = "ouro3.permissao", ['nome'] = "Ouro3", ['payment'] = 6000 },
	{ ['permissao'] = "ouro4.permissao", ['nome'] = "Ouro4", ['payment'] = 6000 },
	{ ['permissao'] = "diamante.permissao", ['nome'] = "Diamante", ['payment'] = 8000 },
	{ ['permissao'] = "diamante2.permissao", ['nome'] = "Diamante2", ['payment'] = 8000 },
	{ ['permissao'] = "diamante3.permissao", ['nome'] = "Diamante3", ['payment'] = 8000 },
	{ ['permissao'] = "diamante4.permissao", ['nome'] = "Diamante4", ['payment'] = 8000 },
	{ ['permissao'] = "esmeralda.permissao", ['nome'] = "Esmeralda", ['payment'] = 12000 },
	{ ['permissao'] = "esmeralda2.permissao", ['nome'] = "Esmeralda2", ['payment'] = 12000 },
	{ ['permissao'] = "esmeralda3.permissao", ['nome'] = "Esmeralda3", ['payment'] = 12000 },
	{ ['permissao'] = "esmeralda4.permissao", ['nome'] = "Esmeralda4", ['payment'] = 12000 },
	{ ['permissao'] = "flush.permissao", ['nome'] = "Flush", ['payment'] = 20000 },
	{ ['permissao'] = "flush2.permissao", ['nome'] = "Flush2", ['payment'] = 20000 },
...
function src.checkMasterPerm()
    ...
    local user_id = vRP.getUserId(source)
    if user_id then
        if vRP.hasPermission(user_id,"esmeralda.permissao") or vRP.hasPermission(user_id,"ac.permissao") or vRP.hasPermission(user_id,"diamante.permissao") or vRP.hasPermission(user_id,"flush.permissao") then
            return true 
        else
...
RegisterCommand('croupa',function(source,args,rawCommand)
    ...
    if vRP.hasPermission(user_id,"mindmaster.permissao") or vRP.hasPermission(user_id, "flush.permissao") then
